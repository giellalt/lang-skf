...
This directory contains source files for the Sakirabiá language
...
-   <https://giellalt.uit.no/lang/skf/index.html> (analyser)
...
The Sakirabiá language sources can be acquired using [giella SVN
