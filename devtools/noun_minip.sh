...
do
 ...
 do
#  echo "${lemma}${form}" | $LOOKUP $GTLANGS/lang-skf/src/fst/generator-gt-norm.xfst
  echo "${lemma}${form}" | $HLOOKUP $GTLANGS/lang-skf/src/fst/generator-gt-norm.hfstol
 done
 rm -f $L_FILE
done
